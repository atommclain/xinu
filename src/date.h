...
/* The Macintosh uses seconds past Jan 1, 1904, local time.		*/

#define	net2xt(x)	((x)-2208988800L)  /* convert net-to-xinu time	*/
#define	xt2net(x)	((x)+2208988800L)  /* convert xinu-to-net time	*/
#define	mac2xt(x)	net2xt((x) + 4*365*SECPERDY + TIMEZONE*SECPERHR)
#define	xt2mac(x)	(xt2net(x) - 4*365*SECPERDY - TIMEZONE*SECPERHR)
...
#define	FEBRUARY	1		/* February's month index	*/
