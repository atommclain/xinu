/* kernel.h - disable, restore, isodd, min, max, ctoi */
...
#define	RESCHNO		FALSE		/* tell	ready not to resch.	*/
...
#define	MINSTK		1600L		/* minimum process stack size	*/
#define	NULLSTK		2000L		/* process 0 stack size		*/
...
#define	INITSTK		2000L		/* initial process stack	*/
...
#define	isodd(x)	(01&(long)(x))
#define	min(a, b)	( (a) < (b)? (a) : (b) )
#define	max(a, b)	( (a) > (b)? (a) : (b) )
#define	ctoi(x)		( (int) (unsigned char) (x) )
