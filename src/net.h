...
#define	NETISTK		2000L		/* stack size for network input	*/
#define	NETOSTK		2000L		/* stack size for network output*/
#define	NETIPRI		100		/* network runs at high priority*/
#define	NETOPRI		(NETIPRI-1)	/* network output priority	*/
...
struct	netinfo	{			/* info and parms. for network	*/
	Bool	valid;			/* is AppleTalk installed?	*/
	...
	Bool	gwvalid;		/* is there a gateway?		*/
