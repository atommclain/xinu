...
#define	RWCSIZ		30		/* size of rwho cache		*/
#define	RWMAXP		600		/* max packet length accepted	*/
#define	RWMINP		60		/* size of rwho pac, no users	*/
#define	RWDELAY		60		/* delay for output in seconds	*/
#define	RWCDOWN		300		/* consider down if this old	*/
...
#define	RWISTK		2000L		/* Rwho input process stack	*/
...
#define	RWOSTK		2000L		/* Rwho output process stack	*/
